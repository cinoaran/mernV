...
import { signUp, oauthGoogle, oauthFacebook } from '../actions';
    ...
    return (
      <div className="container">
        <form className="form-group"  onSubmit={this.handleSubmit}>
            ...
            <p>
              <button className = "btn btn-sm btn-block btn-primary" type="submit">Sign Up</button>
            </p>          
        </form>
        <hr/>
        <p className="text-center mt-2 mb-2">SIGN UP WITH GOOGLE OR FACEBOOK</p>
        <div className="container">
